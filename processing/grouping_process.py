...
class MusicImageOrganizer:
    ...
    def organize_images_by_group(self, source_dir, output_dir):
        ...
        for idx, filename in enumerate(image_files):
            ...
            try:
                action = self._copy_or_move(source_path, dest_path)
    ...
    def organize_grouped_images_by_type_fixed(self, source_dir, output_root, data_type="clefs"):
        ...
        for idx, img_path in enumerate(image_files):
            ...
            try:
                action = self._copy_or_move(img_path, dest_path)
    ...
    def organize_grouped_images_by_type_with_clef(self, staff_source_dir, clef_source_dir, output_root):
        ...
        for idx, staff_path in enumerate(staff_images):
            try:
                ...
                action = self._copy_or_move(staff_path, dest_path)
    ...
    def process_clef_grouping(self, fclef_path, gclef_path, target_path):
        self.organize_images_by_group(fclef_path, target_path)
        self.organize_images_by_group(gclef_path, target_path)

    def process_measure_grouping(self, path, target_path):
        self.organize_images_by_group(path, target_path)

    def group_all_sep_images_fixed(self, clef_sep_path, staffLine_only_path, grouping_path):
        print("📂 Organizing clef images...")
        self.organize_grouped_images_by_type_fixed(clef_sep_path, grouping_path, data_type="clefs")
        print("\n📂 Organizing staff line images...")
        self.organize_grouped_images_by_type_with_clef(staffLine_only_path, clef_sep_path, grouping_path)
